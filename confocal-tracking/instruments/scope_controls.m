...
%SCOPE_CONTROLS M-file for scope_controls.fig
...
%
%      SCOPE_CONTROLS('Property','Value',...) creates a new SCOPE_CONTROLS using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to scope_controls_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      SCOPE_CONTROLS('CALLBACK') and SCOPE_CONTROLS('CALLBACK',hObject,...) call the
%      local function named CALLBACK in SCOPE_CONTROLS.M with the given input
%      arguments.
%
...
% Last Modified by GUIDE v2.5 11-Sep-2014 18:05:47
...
% Choose default command line output for scope_controls
