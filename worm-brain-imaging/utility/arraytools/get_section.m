function section = get_section(start_indices, feature_size, image)
% function section = GET_SECTION(start_indices, feature_size, image)
%
...
% average value on the face to allow extraction of regions that jut out of
% the original image.
...
bigimage_start_indices = feature_size + 1;
