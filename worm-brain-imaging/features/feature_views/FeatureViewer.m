classdef FeatureViewer < matlab.mixin.SetGet
    %FEATUREVIEWER Snapshot of a Feature
    ...
    methods
        ...
        function obj = FeatureViewer(varargin)
            % obj = FEATUREVIEWER(f)
            %
            %   Creates a feature viewer for feature f.
            %
            % obj = FEATUREVIEWER(f, LUT)
            %
